...
?>
<!--<input type="text" name="aa" value="<?php echo $num ?>"  id="num_txt" onchange="start1()"  />-->
...
<script>
    document.getElementById("list").value="<?php echo $num ?>";
    /////////////////////////////////////
      function view() {
...
<!--     <script>
    function start1(){
       alert(document.getElementById("num_txt").value); 
  var str= document.getElementById("num_txt").value;
   document.getElementById("list").value=document.getElementById("num_txt").value;
